...
import com.example.panoroma.ui.list.dummy.DummyContent
 ...
 */
class ItemFragment : Fragment(), OnPanItemClickListener {
    ...
    override fun onItemClick(values: DummyItem, position: Int) {
